...
//========================================================================================
	...
	void expectSkylerJesseComplete(Flux<User> flux) {
		StepVerifier.create(flux)
				.expectNextMatches( user -> Objects.equals(user.getUsername(),User.SKYLER.getUsername()))
				.expectNextMatches( user -> Objects.equals(user.getUsername(),User.JESSE.getUsername()))
				.expectComplete()
				.verify();
	}
